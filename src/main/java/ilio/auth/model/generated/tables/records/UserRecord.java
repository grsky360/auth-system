...
public class UserRecord extends UpdatableRecordImpl<UserRecord> implements Record4<Integer, String, Timestamp, Timestamp> {

    private static final long serialVersionUID = 577866057;
     ...
     */
    @Override
    public UserRecord values(Integer value1, String value2, Timestamp value3, Timestamp value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public UserRecord(Integer id, String username, Timestamp createdTime, Timestamp updatedTime) {
        super(User.USER);
